    ...
    <div class="col-sm-6 col-md-4 col-md-offset-4">
        ...
        <div class="account-wall">
            ...
            {!! Form::open(['route' => 'register.post', 'class' => 'form-signin']) !!}
                ...
                {{ Form::password('password', ['class' => 'form-control input-register-password-up', 'placeholder' => 'Nova Senha', 'required' => 'autofocus'] ) }}
                {{ Form::password('confirm', ['class' => 'form-control input-register-confirm','placeholder' => 'Confirme a nova senha', 'required' => 'autofocus']) }}
